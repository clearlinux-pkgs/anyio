...
Source0  : https://files.pythonhosted.org/packages/dc/e7/7452227e8c091db6838d7f1b50dc4e6323e8463ed8c2d0b651ac9b7f7fce/anyio-3.4.0.tar.gz
...
%prep
%setup -q -n anyio-3.4.0
cd %{_builddir}/anyio-3.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637679787
...
cp %{_builddir}/anyio-3.4.0/LICENSE %{buildroot}/usr/share/package-licenses/anyio/097cca9910ea400331f4eed7d585982b04223e36
