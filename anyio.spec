...
Source0  : https://files.pythonhosted.org/packages/15/34/2e0a5d81a92f29d6e90f096182612411955677eb80986c745bdeb7326424/anyio-3.0.1.tar.gz
...
%prep
%setup -q -n anyio-3.0.1
cd %{_builddir}/anyio-3.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619816314
...
cp %{_builddir}/anyio-3.0.1/LICENSE %{buildroot}/usr/share/package-licenses/anyio/097cca9910ea400331f4eed7d585982b04223e36
