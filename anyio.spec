...
Source0  : https://files.pythonhosted.org/packages/d9/f5/180f7b4c3b2fcdc79e8f71c71c7c3de575d5d08bdb27ee145d23801539db/anyio-3.3.1.tar.gz
...
%prep
%setup -q -n anyio-3.3.1
cd %{_builddir}/anyio-3.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631202981
...
cp %{_builddir}/anyio-3.3.1/LICENSE %{buildroot}/usr/share/package-licenses/anyio/097cca9910ea400331f4eed7d585982b04223e36
