...
Source0  : https://files.pythonhosted.org/packages/66/02/ca9061e93c487a897859e3a41f6c1a4f494038d2791382169b9a0c528175/anyio-3.3.4.tar.gz
...
%prep
%setup -q -n anyio-3.3.4
cd %{_builddir}/anyio-3.3.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635703137
...
cp %{_builddir}/anyio-3.3.4/LICENSE %{buildroot}/usr/share/package-licenses/anyio/097cca9910ea400331f4eed7d585982b04223e36
