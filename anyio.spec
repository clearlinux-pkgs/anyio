...
Source0  : https://files.pythonhosted.org/packages/bf/3f/4d9972a2190759ac2a576c8fa8b64102a11932ccfb10ed928a116e283f5c/anyio-3.3.2.tar.gz
...
%prep
%setup -q -n anyio-3.3.2
cd %{_builddir}/anyio-3.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632752117
...
cp %{_builddir}/anyio-3.3.2/LICENSE %{buildroot}/usr/share/package-licenses/anyio/097cca9910ea400331f4eed7d585982b04223e36
