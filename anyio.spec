...
Source0  : https://files.pythonhosted.org/packages/0f/60/ae005e0c88703f49c2047af8e83ede692704577599c4e488cc6e9ef7ffb6/anyio-3.3.3.tar.gz
...
%prep
%setup -q -n anyio-3.3.3
cd %{_builddir}/anyio-3.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633962144
...
cp %{_builddir}/anyio-3.3.3/LICENSE %{buildroot}/usr/share/package-licenses/anyio/097cca9910ea400331f4eed7d585982b04223e36
